...
for hour in range(24):
	for tenminute in range(6):
		...
		fn = '20160106_%02d%02d_NBR.tif'%(hour,minute)
		print 'opening ' + dr + fn
		try:
			r = gdal.Open(dr+fn)
...
fig = plt.figure()
im = plt.imshow(arr_arr[0],cmap='jet',interpolation='none', vmin=0, vmax=1, extent=(originX,originX+pixelWidth*cols,originY+pixelHeight*rows,originY))
plt.colorbar()
